$(document).ready(function () {
  ...
  // Mengubah border pada gambar dengan alt="Alumni Photo 1"

  // 3. Selektor Hirarki
  $("#alumniList li").css("font-size", "18px");
  // Mengubah font size pada semua <li> di dalam #alumniList

  // 4. Selektor Filter
  $("li:even").css("color", "blue");
  // Mengubah warna teks pada elemen <li> genap
  $(".featured").addClass("highlight");
  // Menambahkan class highlight pada elemen dengan class featured
